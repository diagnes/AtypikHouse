 ...
 */
final class Version20180716192243 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE address (id INT AUTO_INCREMENT NOT NULL, street_number VARCHAR(10) DEFAULT NULL, address VARCHAR(100) NOT NULL, city VARCHAR(45) NOT NULL, state VARCHAR(45) NOT NULL, postal_code VARCHAR(8) NOT NULL, country VARCHAR(35) NOT NULL, additional_address VARCHAR(45) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, personal_info INT DEFAULT NULL, professional_info INT DEFAULT NULL, score_card INT DEFAULT NULL, username VARCHAR(180) NOT NULL, username_canonical VARCHAR(180) NOT NULL, email VARCHAR(180) NOT NULL, email_canonical VARCHAR(180) NOT NULL, enabled TINYINT(1) NOT NULL, salt VARCHAR(255) DEFAULT NULL, password VARCHAR(255) NOT NULL, last_login DATETIME DEFAULT NULL, confirmation_token VARCHAR(180) DEFAULT NULL, password_requested_at DATETIME DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', facebook_id VARCHAR(255) DEFAULT NULL, facebook_access_token VARCHAR(255) DEFAULT NULL, google_id VARCHAR(255) DEFAULT NULL, google_access_token VARCHAR(255) DEFAULT NULL, user_access_token VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D64992FC23A8 (username_canonical), UNIQUE INDEX UNIQ_8D93D649A0D96FBF (email_canonical), UNIQUE INDEX UNIQ_8D93D649C05FB297 (confirmation_token), UNIQUE INDEX UNIQ_8D93D649FA83366A (personal_info), UNIQUE INDEX UNIQ_8D93D649D9CC0889 (professional_info), UNIQUE INDEX UNIQ_8D93D6493C0C19A5 (score_card), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_personal_infos (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, image_id INT DEFAULT NULL, address_id INT DEFAULT NULL, gender VARCHAR(1) DEFAULT NULL, firstname VARCHAR(45) NOT NULL, lastname VARCHAR(45) NOT NULL, birth_date DATETIME DEFAULT NULL, birth_location VARCHAR(45) DEFAULT NULL, description LONGTEXT DEFAULT NULL, phone_number VARCHAR(10) DEFAULT NULL, profession VARCHAR(45) DEFAULT NULL, nationality VARCHAR(45) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_DD161B22A76ED395 (user_id), INDEX IDX_DD161B223DA5256D (image_id), UNIQUE INDEX UNIQ_DD161B22F5B7AF75 (address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE money_movement (id INT AUTO_INCREMENT NOT NULL, payment_infos_id INT DEFAULT NULL, state VARCHAR(45) NOT NULL, action VARCHAR(45) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_15B766D9148C0EA2 (payment_infos_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE housing (id INT AUTO_INCREMENT NOT NULL, proprietary INT DEFAULT NULL, address_id INT DEFAULT NULL, type_id INT DEFAULT NULL, title VARCHAR(45) NOT NULL, state VARCHAR(15) NOT NULL, description LONGTEXT DEFAULT NULL, visible VARCHAR(15) DEFAULT \'0\' NOT NULL, price DOUBLE PRECISION NOT NULL, max_resident INT NOT NULL, slug VARCHAR(45) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_FB8142C3989D9B62 (slug), INDEX IDX_FB8142C3D4D54AC2 (proprietary), UNIQUE INDEX UNIQ_FB8142C3F5B7AF75 (address_id), INDEX IDX_FB8142C3C54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE housing_detail (id INT AUTO_INCREMENT NOT NULL, housing_type_id INT DEFAULT NULL, name VARCHAR(45) NOT NULL, `label` LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_B5B1BEE57CB1EF5B (housing_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE housing_detail_value (id INT AUTO_INCREMENT NOT NULL, detail_id INT DEFAULT NULL, housing_id INT DEFAULT NULL, value LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_186A9DE8D8D003BB (detail_id), INDEX IDX_186A9DE8AD5873E3 (housing_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE housing_type (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(45) NOT NULL, slug VARCHAR(45) NOT NULL, description LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE housing_undisponibility (id INT AUTO_INCREMENT NOT NULL, housing_id INT DEFAULT NULL, start_date DATETIME NOT NULL, INDEX IDX_354703D3AD5873E3 (housing_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, housing_id INT DEFAULT NULL, user_id INT DEFAULT NULL, reservation_infos INT DEFAULT NULL, state VARCHAR(45) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_42C84955AD5873E3 (housing_id), INDEX IDX_42C84955A76ED395 (user_id), UNIQUE INDEX UNIQ_42C84955ADB552CA (reservation_infos), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reservation_infos (id INT AUTO_INCREMENT NOT NULL, reservation_id INT DEFAULT NULL, resident INT NOT NULL, startDate DATETIME NOT NULL, endDate DATETIME NOT NULL, message LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_ADB552CAB83297E7 (reservation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649FA83366A FOREIGN KEY (personal_info) REFERENCES user_personal_infos (id)');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649D9CC0889 FOREIGN KEY (professional_info) REFERENCES user_professional_infos (id)');
        ...
        $this->addSql('ALTER TABLE user_personal_infos ADD CONSTRAINT FK_DD161B223DA5256D FOREIGN KEY (image_id) REFERENCES media__media (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE user_personal_infos ADD CONSTRAINT FK_DD161B22F5B7AF75 FOREIGN KEY (address_id) REFERENCES address (id)');
        ...
        $this->addSql('ALTER TABLE housing_detail ADD CONSTRAINT FK_B5B1BEE57CB1EF5B FOREIGN KEY (housing_type_id) REFERENCES housing_type (id)');
        ...
        $this->addSql('ALTER TABLE housing_undisponibility ADD CONSTRAINT FK_354703D3AD5873E3 FOREIGN KEY (housing_id) REFERENCES housing (id)');
        ...
        $this->addSql('ALTER TABLE reservation_infos ADD CONSTRAINT FK_ADB552CAB83297E7 FOREIGN KEY (reservation_id) REFERENCES reservation (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_personal_infos DROP FOREIGN KEY FK_DD161B22F5B7AF75');
        ...
        $this->addSql('ALTER TABLE user DROP FOREIGN KEY FK_8D93D649FA83366A');
        $this->addSql('ALTER TABLE user DROP FOREIGN KEY FK_8D93D649D9CC0889');
        ...
        $this->addSql('ALTER TABLE housing_undisponibility DROP FOREIGN KEY FK_354703D3AD5873E3');
        ...
        $this->addSql('ALTER TABLE housing_detail DROP FOREIGN KEY FK_B5B1BEE57CB1EF5B');
        $this->addSql('ALTER TABLE payment_infos DROP FOREIGN KEY FK_B983B4DFB83297E7');
        $this->addSql('ALTER TABLE reservation_infos DROP FOREIGN KEY FK_ADB552CAB83297E7');
        ...
        $this->addSql('ALTER TABLE user_personal_infos DROP FOREIGN KEY FK_DD161B223DA5256D');
        ...
        $this->addSql('DROP TABLE housing_undisponibility');
        $this->addSql('DROP TABLE article');
        $this->addSql('DROP TABLE grade');
        $this->addSql('DROP TABLE reservation');
        $this->addSql('DROP TABLE reservation_infos');
